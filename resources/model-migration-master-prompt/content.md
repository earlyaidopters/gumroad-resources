...
```
REFINED MASTER COMPARISON PROMPT

You are an AI model migration expert. I need help adapting my prompts from one AI model to another.

**Model A (Current):** [Paste current model's documentation/card here]

**Model B (New):** [Paste new model's documentation/card here]
...
**PART 5: MY CUSTOM PROMPT (Optional)**

[If I paste my own prompt here]:
[Your prompt]
...
Please write everything in clear, conversational English. Skip the technical jargon - just tell me what I need to know to make my prompts work. Focus only on practical changes that will actually affect my results.
```

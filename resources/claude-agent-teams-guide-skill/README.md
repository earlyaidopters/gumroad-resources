...
Excalidraw Canvas: Ready-to-use .excalidraw file with all diagrams arranged for presentations or video b-roll.
...
- [`agent_teams_diagrams.zip`](files/agent_teams_diagrams.zip)
- [`BUILD-PROMPT.md`](files/BUILD-PROMPT.md)
